...
config.window_frame.active_titlebar_bg = '#7f796d'
config.window_frame.inactive_titlebar_bg = '#7f796d'

config.colors = {
    tab_bar = {
        background = '#fdf8f4',
        active_tab = { bg_color = '#fdf8f4', fg_color = '#494441', underline = 'Double', },
